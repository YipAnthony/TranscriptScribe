...
import { IconUsers, IconFileDescription, IconCalendar, IconUpload } from "@tabler/icons-react"
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage patients, appointments, and trial recommendations
          </p>
        </div>
        <Button>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              Latest patient interactions and transcript uploads
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Transcript uploaded</p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Trial recommendation generated</p>
